<x-slide-form button-text="Edit Property" title="Edit Property">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="mb-8">
                    ...
                    <div id="current-featured-image" class="mb-4">
                        <div class="bg-gray-50 rounded-lg p-4 border-2 border-gray-200">
                            <div class="flex items-start justify-between mb-2">
                                <h4 class="text-sm font-semibold text-gray-700">Current Featured Image:</h4>
                                <button type="button" onclick="removeCurrentFeatured()"
                    ...
                    <div class="mb-4">
                        <label for="featured_image"
                            ...
                            {{ $property->featured_image ? 'Replace Featured Image' : 'Choose Featured Image' }}
                        </label>
                    ...
                    <div id="featured-preview-container" class="hidden">
                        <div class="bg-gray-50 rounded-lg p-4 border-2 border-green-300">
                            <div class="flex items-start justify-between mb-2">
                                <h4 class="text-sm font-semibold text-green-700">New Image Preview:</h4>
    ...
    <script>
        ...
        function removeCurrentFeatured() {
            const currentFeatured = document.getElementById('current-featured-image');
            ...
            if (confirm('Are you sure you want to remove the current featured image?')) {
                currentFeatured.style.display = 'none';
                removeInput.value = '1';
            }
        }
        ...
        function removeCurrentGalleryImage(index) {
            if (confirm('Are you sure you want to remove this image?')) {
                const imageElement = document.querySelector(`[data-image-id="${index}"]`);
                if (imageElement) {
                    ...
                    // Update count
                    const remainingImages = document.querySelectorAll('#current-gallery-grid > div:not([style*="display: none"])').length;
                    document.getElementById('current-gallery-count').textContent = remainingImages;
                    
                    // Hide entire section if no images remain
                    if (remainingImages === 0) {
                        document.getElementById('current-gallery-images').style.display = 'none';
                    }
                }
            }
        }

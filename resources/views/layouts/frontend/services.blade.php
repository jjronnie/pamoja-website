    ...
    <section id="services" class="py-16 md:py-20 bg-gray-100">
        <div class="container mx-auto px-6 lg:px-12">
            <div class="text-center mb-12 md:mb-16">
                ...
                <h2 class="text-2xl md:text-3xl lg:text-4xl font-bold text-gray-900 mb-4">Comprehensive Legal & Property
                    Solutions</h2>
                <p class="text-gray-600 max-w-2xl mx-auto">We offer a full range of professional services tailored to
                    meet your needs</p>
            </div>

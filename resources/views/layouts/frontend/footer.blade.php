        ...
        <div class="container mx-auto px-6 lg:px-12">
            <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        <li><a href="#about"
                                class="text-gray-400 hover:text-red-500 transition text-sm md:text-base">About Us</a>
                        </li>
                        <li><a href="#services"
                        ...
                        <li><a href="#" class="text-gray-400 hover:text-red-500 transition text-sm md:text-base">Privacy
                                Policy</a></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        <li><a href="#" class="text-gray-400 hover:text-red-500 transition text-sm md:text-base">Debt
                                Collection</a></li>
                        <li><a href="#" class="text-gray-400 hover:text-red-500 transition text-sm md:text-base">Court
                                Bailiffs</a></li>
                        <li><a href="#"
                                class="text-gray-400 hover:text-red-500 transition text-sm md:text-base">Property
                                Sales</a></li>
                        <li><a href="#" class="text-gray-400 hover:text-red-500 transition text-sm md:text-base">Legal
                                Consultants</a></li>
                        <li><a href="#"
